...
function App() {
  ...
  const editarTarea = (event)=> {
    ...
    setTareas(tareas.map((item)=>  item.id === id ? {id,nombreTarea:tarea} : item));
    ...
    <div className="container">
      ...
      <main className="row">
        <section className="col-8">
          ...
          <ul className="list-group">
            ...
            : (
              ...
              className="btn btn-sm btn-danger float-end mx-2" type="button">
                Eliminar
              </button>
        ...
        {error? ( <span className="text-danger">{error}</span>): null}
          ...
          {
            modoEdicion ? (<button type="submit" className="btn btn-warning w-100">Editar</button>)
